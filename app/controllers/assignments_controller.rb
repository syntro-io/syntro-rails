class AssignmentsController < ApplicationController
  ...
  def create
    ...
    if @assignment.version.nil?
      ...
      saveResult = nil
    elsif @assignment.test_plan.nil? && @assignment.stencil.nil?
  ...
  def update_ticket_issue_select
    ...
    issues = {}
    if product.ticket_project_id.present? && version.ticket_version_id.present?
