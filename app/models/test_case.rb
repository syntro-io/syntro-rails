class TestCase < ActiveRecord::Base
  ...
  accepts_nested_attributes_for :steps, allow_destroy: true, reject_if: ->(a) { a[:action].blank? }
  accepts_nested_attributes_for :test_case_targets, allow_destroy: true, reject_if: ->(a) { a[:filename].blank? }
